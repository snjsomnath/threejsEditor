...
export const BuildingEditPanel: React.FC<BuildingEditPanelProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-gray-900/95 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-700 w-full max-w-md max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-2.5 py-1.5 bg-gray-800 border border-gray-600 rounded-lg text-white text-sm
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-300 mb-1.5">
                Height: {editedBuilding.floorHeight}m
              </label>
              <input
                type="range"
                min="2.5"
          ...
          <div className="space-y-3">
            ...
            {/* Color Selection */}
            <div>
              <label className="block text-xs font-medium text-gray-300 mb-1.5">Building Color</label>
          ...
          <div className="bg-gray-800/30 rounded-lg p-3">
            <h4 className="text-white font-medium text-xs mb-2">Statistics</h4>
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="space-y-1.5">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-300">Usable:</span>
        ...
        <div className="flex items-center justify-between p-4 border-t border-gray-700">
          <button
            onClick={handleReset}
            disabled={!hasChanges}
            className="flex items-center space-x-1.5 px-3 py-1.5 text-gray-400 hover:text-white 
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              onClick={handleSave}
              disabled={!hasChanges}
              className="flex items-center space-x-1.5 px-4 py-1.5 bg-blue-600 hover:bg-blue-700 
